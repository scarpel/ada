...
class ShopWebsiteInfo extends WebsiteInfo{
    constructor(id, url, domain, name, hasJavascript=false, faviconExtension = "ico", titleIds=null, imgIds=null){
        ...
        this.faviconExtension = faviconExtension
    }
    ...
    static from_db(info, titleIds, imgIds){
        return new this(info.id, info.url, get_domain(info.url), info.name, info.hasJavascript? true:false, info.faviconExtension, titleIds, imgIds)
    }
}
