...
export default class Calendar{
    ...
    displayMonth = async (monthObj) => {
        ...
        await this.displayMonthCallback(this.currentYear, this.currentMonth, this.currentDay)
        this.updateMonthWithEvents(await this.getMonthEvents(this.currentYear, this.currentMonth))
        await this.selectDay(this.currentDay)
    }
    ...
    selectDay = async (day) => {
        ...
        if(element){
            ...
            await this.selectDayCallback(day)
